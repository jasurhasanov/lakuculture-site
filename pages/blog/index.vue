    ...
    <main>
      <header class="hero">
        <div class="shell">
          ...
          <h1>Lombok culture guides for meaningful days in South Lombok</h1>
          <p>Practical stories and planning guides for travelers, families, couples, residents, and curious learners who want to experience living culture at LAKU.</p>
        </div>
      </header>
...
const description = 'Lombok culture guides for travelers, families, couples, residents, and curious learners planning LAKU workshops and visits.'
