  ...
  <div class="laku-page">
    ...
    <header class="hero">
      <div class="shell hero-grid">
        ...
        <div class="hero-panel" aria-label="Traditional Indonesian weaving practice">
